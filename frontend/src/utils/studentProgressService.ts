...
const SEED: Record<string, SeedData> = {
  ...
  s003: {
    ...
    achievements: [],
    insights: [
      { id: "i1", text: "Start with the lecture examples", detail: "The ECMP Triangle lecture shows step-by-step how traffic splits — it's the foundation for all three challenges.", type: "suggestion" },
      { id: "i2", text: "Hints are your friend", detail: "Hints are penalty-free on your first reveal. Use them when you're unsure about the approach.", type: "suggestion" },
      { id: "i3", text: "Try the ECMP Triangle first", detail: "It's the quickest path to your first completed challenge. Most students finish it in under 10 minutes.", type: "positive" },
    ],
    timeline: [
      { minsAgo: 2880, action: "lecture", title: "Opened lecture: ECMP Triangle", detail: "Lecture example · ECMP" },
    ],
    continueItems: [
      { id: "c1", title: "ECMP Triangle: Find the Congested Link", type: "challenge", estimatedMinutes: 10, progressPct: 0, cta: "Start", score: null, challengeId: "challenge-ecmp-triangle-congestion" },
